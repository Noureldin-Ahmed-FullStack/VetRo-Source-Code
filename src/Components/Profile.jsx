                        ...
                        <div className='position-relative'>
                            ...
                            <div className='display row'>
                                <div className="card text-center align-items-center w-100 bg-white py-4 rounded shadow">
                                    <div className="row"  >
                                        <div className=""><img src={ProfileData.userPFP} className="avatar circle-round" />
                                            ...
                                            <div>
                                                <h4>
                                                    Dr.{ProfileData.DoctorName}'s Clinics
                                                </h4>
                                            </div>
                                        </div>
                                                    ...
                                                    <div key={index} onClick={() => console.log(clinic)} className="col-4 col-sm-4 col-md-4 col-lg-4 ">
                                                        {
                                                            clinic.image ? (
                                                                ...
                                                                <img src='/clinicPlaceHolder.jpg' className="profile-pic pointer" />
                                                            )
                                                        }
                                                    </div>
                                                ...
                                                <div className=''>
                                                    {
                                                        clinicData[0]?.image ? (
                                                            ...
                                                            <img src='/clinicPlaceHolder.jpg' className="pet-pic2" />
                                                        )
                                                    }
                                    ...
                                    <div className="row"  >
                                        <div className=""><img src={ProfileData?.userPFP} className="avatar circle-round" />
                                            <div className="about-info my-2">
                                                ...
                                                <div className="py-1 " ><a className='mail' href={`mailto: ${ProfileData?.email}`}>{ProfileData?.email}</a></div>
                                            </div>
                                            <hr className='w-100' />
                                            <div>
                                                <h4>
                                                    {ProfileData?.userName}'s Pets
                                                </h4>
                                            </div>
                                        </div>
                                        ...
                                        <div className='row justify-content-center'>

                                            {
                                                PetsData.map((Pet, index) => (
                                                    <div key={Pet.PetID} onClick={() => console.log(Pet)} className="col-4 col-sm-4 col-md-4 col-lg-4 ">
                                                        {
                                                            Pet.image ? (
                                                                <img src={Pet.image} className="profile-pic pointer" />
                                                            ) : (
                                                                <img src='/PetPlaceHolder.jpg' className="profile-pic pointer" />
                                                            )
                                                        }
                                                    </div>
